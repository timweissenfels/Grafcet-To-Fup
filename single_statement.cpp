...
namespace grfc {
    single_statement::single_statement(const bool _is_inverted, const grfc::identifier _literal_and_num, const grfc::conn _type) : is_inverted(_is_inverted), type(_type), literal_and_num(_literal_and_num) { }
